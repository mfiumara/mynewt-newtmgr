...
2. Rename resulting `apache-mynewt-newtmgr-1.3.0` directory to `$GOPATH/src/github.com/mfiumara/mynewt-newtmgr`
3. `cd $GOPATH/src/github.com/mfiumara/mynewt-newtmgr/newtmgr`
